<%@ Page Title="CV - Ciudades" Language="vb" AutoEventWireup="false" MasterPageFile="~/_Plantilla.Master" CodeBehind="CiudadesView.aspx.vb" Inherits="Adya.CV.Web.CiudadesView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_contenido" runat="server">
    ...
    <table class="nav-justified">
        <tr>
          ...
          <td class="quince alinear_der">
            <asp:Label ID="lbl_nombres" runat="server" Text="Ciudad"></asp:Label>
          </td>
  ...
  <asp:Panel ID="pnl_list" runat="server">
    ...
    <asp:GridView ID="grd_Ciudades" runat="server" AutoGenerateColumns="False" DataKeyNames="CiudadId" DataSourceID="sds_Ciudades" CssClass="table table-bordered" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True" AllowSorting="True">
      ...
      <Columns>
        ...
        <asp:BoundField DataField="CiudadId" HeaderText="CiudadId" InsertVisible="False" ReadOnly="True" SortExpression="CiudadId" Visible="False" />
        <asp:BoundField DataField="Nombre" HeaderText="Ciudad" SortExpression="Nombre" />
      </Columns>
      <HeaderStyle ForeColor="White" BackColor="#005490" />
    </asp:GridView>
    <asp:SqlDataSource ID="sds_Ciudades" runat="server" ConnectionString="<%$ ConnectionStrings:CVConnectionString %>" SelectCommand="CiudadesListar" SelectCommandType="StoredProcedure">
      <SelectParameters>
