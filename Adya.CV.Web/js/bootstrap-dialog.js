...
(function(root, factory) {
    ...
    BootstrapDialog.TYPE_CORPORATIVO = 'type-corporativo';
    ...
    BootstrapDialog.DEFAULT_TEXTS[BootstrapDialog.TYPE_CORPORATIVO] = 'Corporativo';
        ...
        updateType: function() {
            if (this.isRealized()) {
                var types = [BootstrapDialog.TYPE_DEFAULT,
                    ...
                    BootstrapDialog.TYPE_CORPORATIVO];
