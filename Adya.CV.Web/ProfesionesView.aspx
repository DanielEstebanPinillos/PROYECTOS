<%@ Page Title="CV - Profesiones" Language="vb" AutoEventWireup="false" MasterPageFile="~/_Plantilla.Master" CodeBehind="ProfesionesView.aspx.vb" Inherits="Adya.CV.Web.ProfesionesView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_contenido" runat="server">
    ...
    <table class="nav-justified">
        <tr>
          ...
          <td class="quince alinear_der">
            <asp:Label ID="lbl_nombres" runat="server" Text="Profesion"></asp:Label>
          </td>
  ...
  <asp:Panel ID="pnl_list" runat="server">
        ...
        <tr>
          ...
          <td class="veinte" align="center">
            <asp:DropDownList ID="ddl_buscar" runat="server" CssClass="dropdown btn btn-default dropdown-toggle text-center ochenta">
              ...
              <asp:ListItem Value="1">Profesion</asp:ListItem>
            </asp:DropDownList>
          </td>
          <td class="veinte">
    ...
    <asp:GridView ID="grd_Profesiones" runat="server" AutoGenerateColumns="False" DataKeyNames="ProfesionId" DataSourceID="sds_Profesiones" CssClass="table table-bordered" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True" AllowSorting="True">
      ...
      <asp:CommandField ShowSelectButton="True" ControlStyle-CssClass="fa fa-pencil" ItemStyle-HorizontalAlign="Center" SelectText="">
        ...
        <asp:BoundField DataField="ProfesionId" HeaderText="ProfesionId" InsertVisible="False" ReadOnly="True" SortExpression="ProfesionId" Visible="False" />
        <asp:BoundField DataField="Nombre" HeaderText="Profesion" SortExpression="Nombre" />
      </Columns>
      <HeaderStyle ForeColor="White" BackColor="#005490" />
    </asp:GridView>
    <asp:SqlDataSource ID="sds_Profesiones" runat="server" ConnectionString="<%$ ConnectionStrings:CVConnectionString %>" SelectCommand="ProfesionesListar" SelectCommandType="StoredProcedure">
      <SelectParameters>
  ...
  <script type="text/javascript">
    $(document).ready(function () {
      ...
      $("#li_profesiones").attr("class", "active");
    });
