<%@ Page Title="CV - Cargos" Language="vb" AutoEventWireup="false" MasterPageFile="~/_Plantilla.Master" CodeBehind="CargosView.aspx.vb" Inherits="Adya.CV.Web.CargosView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_contenido" runat="server">
  ...
  <asp:Panel ID="pnl_list" runat="server">
    ...
    <asp:GridView ID="grd_Cargos" runat="server" AutoGenerateColumns="False" DataKeyNames="CargoId" DataSourceID="sds_Cargos" CssClass="table table-bordered" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True" AllowSorting="True">
      ...
      <Columns>
        ...
        <asp:BoundField DataField="CargoId" HeaderText="CargoId" InsertVisible="False" ReadOnly="True" SortExpression="CargoId" Visible="False" />
    ...
    <asp:SqlDataSource ID="sds_Cargos" runat="server" ConnectionString="<%$ ConnectionStrings:CVConnectionString %>" SelectCommand="CargosListar" SelectCommandType="StoredProcedure">
      <SelectParameters>
