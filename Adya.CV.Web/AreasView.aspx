<%@ Page Title="CV - Areas" Language="vb" AutoEventWireup="false" MasterPageFile="~/_Plantilla.Master" CodeBehind="AreasView.aspx.vb" Inherits="Adya.CV.Web.AreasView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_contenido" runat="server">
    ...
    <table class="nav-justified">
        <tr>
          ...
          <td class="quince alinear_der">
            <asp:Label ID="lbl_nombres" runat="server" Text="Area"></asp:Label>
          </td>
  ...
  <asp:Panel ID="pnl_list" runat="server">
    ...
    <asp:GridView ID="grd_Areas" runat="server" AutoGenerateColumns="False" DataKeyNames="AreaId" DataSourceID="sds_Areas" CssClass="table table-bordered" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True" AllowSorting="True">
      ...
      <Columns>
        ...
        <asp:BoundField DataField="AreaId" HeaderText="AreaId" InsertVisible="False" ReadOnly="True" SortExpression="AreaId" Visible="False" />
        <asp:BoundField DataField="Nombre" HeaderText="Area" SortExpression="Nombre" />
      </Columns>
      <HeaderStyle ForeColor="White" BackColor="#005490" />
    </asp:GridView>
    <asp:SqlDataSource ID="sds_Areas" runat="server" ConnectionString="<%$ ConnectionStrings:CVConnectionString %>" SelectCommand="AreasListar" SelectCommandType="StoredProcedure">
      <SelectParameters>
