<%@ Page Title="CV - Actividades" Language="vb" AutoEventWireup="false" MasterPageFile="~/_Plantilla.Master" CodeBehind="ActividadesView.aspx.vb" Inherits="Adya.CV.Web.ActividadesView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_contenido" runat="server">
    ...
    <table class="nav-justified">
        <tr>
          ...
          <td class="quince alinear_der">
            <asp:Label ID="lbl_nombres" runat="server" Text="Actividad"></asp:Label>
          </td>
  ...
  <asp:Panel ID="pnl_list" runat="server">
    ...
    <asp:GridView ID="grd_Actividades" runat="server" AutoGenerateColumns="False" DataKeyNames="ActividadId" DataSourceID="sds_Actividades" CssClass="table table-bordered" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True" AllowSorting="True">
      ...
      <Columns>
        ...
        <asp:BoundField DataField="ActividadId" HeaderText="ActividadId" InsertVisible="False" ReadOnly="True" SortExpression="ActividadId" Visible="False" />
        <asp:BoundField DataField="Nombre" HeaderText="Actvidad" SortExpression="Nombre" />
      </Columns>
      <HeaderStyle ForeColor="White" BackColor="#005490" />
    </asp:GridView>
    <asp:SqlDataSource ID="sds_Actividades" runat="server" ConnectionString="<%$ ConnectionStrings:CVConnectionString %>" SelectCommand="ActvidadesListar" SelectCommandType="StoredProcedure">
      <SelectParameters>
  ...
  <script type="text/javascript">
    $(document).ready(function () {
      ...
      $("#li_actividades").attr("class", "active");
    });
