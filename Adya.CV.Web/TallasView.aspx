<%@ Page Title="CV - Tallas" Language="vb" AutoEventWireup="false" MasterPageFile="~/_Plantilla.Master" CodeBehind="TallasView.aspx.vb" Inherits="Adya.CV.Web.TallasView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_contenido" runat="server">
    ...
    <table class="nav-justified">
        <tr>
          ...
          <td class="quince alinear_der">
            <asp:Label ID="lbl_nombres" runat="server" Text="Talla"></asp:Label>
          </td>
  ...
  <asp:Panel ID="pnl_list" runat="server">
        ...
        <tr>
          ...
          <td class="veinte" align="center">
            <asp:DropDownList ID="ddl_buscar" runat="server" CssClass="dropdown btn btn-default dropdown-toggle text-center ochenta">
              ...
              <asp:ListItem Value="1">Talla</asp:ListItem>
            </asp:DropDownList>
          </td>
          <td class="veinte">
    ...
    <asp:GridView ID="grd_Tallas" runat="server" AutoGenerateColumns="False" DataKeyNames="TallaId" DataSourceID="sds_Tallas" CssClass="table table-bordered" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True" AllowSorting="True">
      ...
      <Columns>
        ...
        <asp:BoundField DataField="TallaId" HeaderText="TallaId" InsertVisible="False" ReadOnly="True" SortExpression="TallaId" Visible="False" />
        <asp:BoundField DataField="Nombre" HeaderText="Nombre" SortExpression="Nombre" />
      </Columns>
      <HeaderStyle ForeColor="White" BackColor="#005490" />
    </asp:GridView>
    <asp:SqlDataSource ID="sds_Tallas" runat="server" ConnectionString="<%$ ConnectionStrings:CVConnectionString %>" SelectCommand="TallasListar" SelectCommandType="StoredProcedure">
      <SelectParameters>
